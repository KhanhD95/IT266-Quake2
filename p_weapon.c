...
void Weapon_RocketLauncher (edict_t *ent)
{
	...
	Weapon_Generic (ent, 4, 5, 50, 54, pause_frames, fire_frames, Weapon_RocketLauncher_Fire); //change frame to 5
}
...
void Weapon_Blaster (edict_t *ent)
{
	...
	Weapon_Generic (ent, 4, 5, 52, 55, pause_frames, fire_frames, Weapon_Blaster_Fire); //changed frame to 5
}
...
void Weapon_HyperBlaster (edict_t *ent)
{
	...
	Weapon_Generic (ent, 5, 10, 49, 53, pause_frames, fire_frames, Weapon_HyperBlaster_Fire); // change frame to 10
}
...
void Weapon_Shotgun (edict_t *ent)
{
	...
	Weapon_Generic (ent, 7, 8, 36, 39, pause_frames, fire_frames, weapon_shotgun_fire); // change frame to 8
}
...
void Weapon_SuperShotgun (edict_t *ent)
{
	...
	Weapon_Generic (ent, 6,7, 57, 61, pause_frames, fire_frames, weapon_supershotgun_fire); //change frame to 7
}
